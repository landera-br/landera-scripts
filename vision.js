...
const INPUT_SLIDE = (before) =>
	`<div class="swiper-slide"><div class="image-wrapper"><img src="${before}?t=${Date.now()}" loading="lazy" sizes="(max-width: 479px) 66vw, (max-width: 767px) 79vw, (max-width: 991px) 59vw, (max-width: 1279px) 62vw, (max-width: 1439px) 64vw, (max-width: 1919px) 67vw, 73vw" alt="" class="image-61" style="display:none;" onload="this.style.display='block';"><a href="#" class="btn-generate w-button">Gerar imagem</a></div></div>`;
