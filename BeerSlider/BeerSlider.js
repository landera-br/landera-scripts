	...
	return (function (t) {
			...
			n(11)('inspectSource', function (t) {
				...
				(t.exports = function (t, e, n, u) {
					'function' == typeof n &&
						...
						t === r ? c(e, n) : u ? (t[e] ? (t[e] = n) : o(t, e, n)) : (delete t[e], o(t, e, n));
			...
			t.exports = function (t, e, n, v, g, m, x) {
				...
				if (
					(L &&
						...
						d !== Object.prototype &&
							b.next &&
							(f || i(b) === d || (c ? c(b, d) : 'function' != typeof b[l] && a(b, l, y)),
							u(b, O, !0, !0),
							f && (p[O] = y))),
					'values' == g &&
						T &&
		...
		function (t, e, n) {
			...
			var r,
				...
				l = !1;
			[].keys &&
				('next' in (i = [].keys()) ? (o = c(c(i))) !== Object.prototype && (r = o) : (l = !0)),
				void 0 == r && (r = {}),
				s ||
					a(r, f) ||
					u(r, f, function () {
			...
			var r,
							...
							for (
								var o = e.value,
									...
									u = function (n) {
										...
										try {
											a
												? (i || (2 === e.rejection && U(t, e), (e.rejection = 1)),
												  !0 === a
														? (r = o)
														: (l && l.enter(), (r = a(o)), l && (l.exit(), (u = !0))),
												  r === n.promise
				...
				W = function (t, e, n) {
					...
					D
						...
						(o = a['on' + t])
							? o(r)
							: 'unhandledrejection' === t && b('Unhandled promise rejection', n);
				},
				z = function (t, e) {
					g.call(a, function () {
						var n,
			...
			e.BeerSlider = (function () {
				function t(e) {
					...
					!(function (t, e) {
						...
						(this.start = parseInt(o) ? Math.min(100, Math.max(0, parseInt(o))) : 50),
						(this.prefix = c),
						e &&
							2 === e.children.length &&
							((this.element = e),
